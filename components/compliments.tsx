  ...
  return (
    <div className="mb-4">
      ...
      <textarea
        ...
        className="pl-1 mt-1 w-full h-8 sm:text-sm border-2 border-pink-400 rounded-md focus:ring-pink-500 focus:border-pink-500 transition duration-150 ease-in-out"
      ...
      <textarea
        ...
        rows={4}
        className="pl-1 mt-1 block w-full sm:text-sm border-2 border-pink-400 rounded-md focus:ring-pink-500 focus:border-pink-500 transition duration-150 ease-in-out"
